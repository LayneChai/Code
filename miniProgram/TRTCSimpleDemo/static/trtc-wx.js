! function (e, t) {
  ...
  function n() {
    var e = (new Date).getTime(),
      ...
      i = t.getSeconds(),
      a = t.getMilliseconds();
    return r = r < 10 ? "0".concat(r) : r, s = s < 10 ? "0".concat(s) : s, i = i < 10 ? "0".concat(i) : i, "".concat(r, ":").concat(s, ":").concat(i, ".").concat(a)
  }
  var o = "TRTC-WX",
    u = 0,
    c = 1,
    l = new(function () {
      ...
      return r(t, [{
        ...
        value: function () {
          var e;
          this.logLevel === u && (e = console).log.apply(e, [o, n()].concat(Array.prototype.slice.call(arguments)))
        }
      }, {
        key: "warn",
        value: function () {
          var e;
          this.logLevel <= c && (e = console).warn.apply(e, [o, n()].concat(Array.prototype.slice.call(arguments)))
        }
      }, {
        key: "error",
        value: function () {
          var e;
          (e = console).error.apply(e, [o, n()].concat(Array.prototype.slice.call(arguments)))
        }
      }]), t
    }());
  var h = function (e) {
      var t = /[\u4e00-\u9fa5]/;
      return e.sdkAppID ? void 0 === e.roomID && void 0 === e.strRoomID ? (l.error("未设置 roomID"), !1) : !e.strRoomID && (e.roomID < 1 || e.roomID > 4294967296) ? (l.error("roomID 超出取值范围 1 ~ 4294967295"), !1) : e.strRoomID && t.test(e.strRoomID) ? (l.error("strRoomID 请勿使用中文字符"), !1) : e.userID ? e.userID && t.test(e.userID) ? (l.error("userID 请勿使用中文字符"), !1) : !!e.userSig || (l.error("未设置 userSig"), !1) : (l.error("未设置 userID"), !1) : (l.error("未设置 sdkAppID"), !1)
    },
    p = {
  ...
  function v(e) {
    ...
    this.length = function () {
      ...
      r = s.concat(r), t.confirm();
      var i = 1 + r.length + s.length - e;
      i > 0 && (s.splice(0, i), r = s.concat(r), t.confirm())
    }
  }
  var g = new(function () {
      function t() {
    ...
    y = function () {
      ...
      return r(t, [{
        ...
        value: function () {
          var e = this;
          return l.log("[apiLog][pusherSnapshot]"), new Promise((function (t, r) {
            e.context.snapshot({
              quality: "raw",
              complete: function (e) {
        ...
        key: "reset",
        value: function () {
          return console.log("Pusher reset", this.context), this.pusherConfig = {}, this.context && (this.stop({
            success: function () {
    ...
    A = function () {
      function t(r, s) {
        e(this, t), this.ctx = s, this.playerAttributes = {}, Object.assign(this.playerAttributes, f, {
          userID: "",
          streamType: "",
          streamID: "",
          id: "",
      ...
      return r(t, [{
        ...
        value: function (e) {
          var t = this;
          return l.log("[playerSnapshot]", e), new Promise((function (e, r) {
        ...
        key: "reset",
        value: function () {
          this.playerContext && (this.playerContext.stop(), this.playerContext = void 0), Object.assign(this.playerAttributes, f, {
            userID: "",
            streamType: "",
            streamID: "",
            hasVideo: !1,
      ...
      return r(t, [{
        ...
        value: function (e) {
          ...
          switch (t) {
            ...
            case 1008:
              ...
              break;
            case 1018:
              l.log("进房成功", t), g.log("event enterRoom success ".concat(t)), this.emitter.emit(p.LOCAL_JOIN);
              break;
            case 1019:
              l.log("退出房间", t), r.indexOf("reason[0]") > -1 ? g.log("event exitRoom ".concat(t)) : (g.log("event abnormal exitRoom ".concat(r)), this.emitter.emit(p.KICKED_OUT));
              break;
            case 2003:
              l.log("渲染首帧视频", t);
              break;
            case -1301:
              l.error("打开摄像头失败: ", t), g.log("event start camera failed: ".concat(t)), this.emitter.emit(p.ERROR, {
                code: t,
                message: r
              });
              break;
            case -1302:
              l.error("打开麦克风失败: ", t), g.log("event start microphone failed: ".concat(t)), this.emitter.emit(p.ERROR, {
                code: t,
                message: r
              });
              break;
            case -1303:
              l.error("视频编码失败: ", t), g.log("event video encode failed: ".concat(t)), this.emitter.emit(p.ERROR, {
                code: t,
                message: r
              });
              break;
            case -1304:
              l.error("音频编码失败: ", t), g.log("event audio encode failed: ".concat(t)), this.emitter.emit(p.ERROR, {
                code: t,
                message: r
              });
              break;
            case -1307:
              l.error("推流连接断开: ", t), this.emitter.emit(p.ERROR, {
                code: t,
                message: r
              });
              break;
            case -100018:
              l.error("进房失败: userSig 校验失败，请检查 userSig 是否填写正确", t, r), this.emitter.emit(p.ERROR, {
                code: t,
                message: r
              });
              break;
            case 5e3:
              l.log("小程序被挂起: ", t), g.log("小程序被挂起: 5000");
              break;
            case 5001:
              l.log("小程序悬浮窗被关闭: ", t);
              break;
            case 1021:
              l.log("网络类型发生变化，需要重新进房", t);
              break;
            case 2007:
              l.log("本地视频播放loading: ", t);
              break;
            case 2004:
              l.log("本地视频播放开始: ", t);
              break;
        ...
        value: function (e) {
          var t, r = e.detail.code,
            s = e.detail.message;
          if (!e.detail.message || "string" != typeof s) return l.warn(_, "userEventHandler 数据格式错误"), !1;
          try {
        ...
        value: function (e) {
          ...
          Array.isArray(r) && r.length > 0 && r.forEach((function (e) {
            ...
            s || (s = new E({
              ...
              userID: r
            })), t.userMap.set(r, s), t.emitter.emit(p.REMOTE_USER_JOIN, {
              userID: r,
              userList: t.userList,
        ...
        value: function (e) {
          ...
          Array.isArray(r) && r.length > 0 && r.forEach((function (e) {
            var r = e.userid,
              s = t.getUser(r);
            s && s.streams && (t._removeUserAndStream(r), s.streams.main && s.streams.main.reset(), s.streams.aux && s.streams.aux.reset(), t.emitter.emit(p.REMOTE_USER_LEAVE, {
              userID: r,
              userList: t.userList,
              playerList: t.getPlayerList()
        ...
        value: function (e) {
          var t = this;
          l.log(_, "updateUserVideo", e);
          var r = e.userlist;
          Array.isArray(r) && r.length > 0 && r.forEach((function (e) {
            var r = e.userid,
              s = e.streamtype,
              i = "".concat(r, "_").concat(s),
              a = i,
              n = e.hasvideo,
              o = e.playurl,
              u = t.getUser(r);
            if (u) {
              var c = u.streams[s];
              l.log(_, "updateUserVideo start", u, s, c), c ? (c.setPlayerAttributes({
                hasVideo: n
              }), n || c.playerAttributes.hasAudio || t._removeStream(c)) : (c = new A({
                userID: r,
                streamID: i,
                hasVideo: n,
                src: o,
                streamType: s,
                id: a
              }, t.ctx), u.streams[s] = c, t._addStream(c)), "aux" === s && (n ? (c.objectFit = "contain", t._addStream(c)) : t._removeStream(c)), t.userList.find((function (e) {
                if (e.userID === r) return e["has".concat(s.replace(/^\S/, (function (e) {
                  return e.toUpperCase()
                })), "Video")] = n, !0
              })), l.log(_, "updateUserVideo end", u, s, c);
              var h = n ? p.REMOTE_VIDEO_ADD : p.REMOTE_VIDEO_REMOVE;
              t.emitter.emit(h, {
          ...
          Array.isArray(r) && r.length > 0 && r.forEach((function (e) {
            ...
            if (u) {
              ...
              c ? (c.setPlayerAttributes({
                hasAudio: n
              }), n || c.playerAttributes.hasVideo || t._removeStream(c)) : (c = new A({
                userID: r,
                streamID: i,
                hasAudio: n,
                src: o,
              ...
              var l = n ? p.REMOTE_AUDIO_ADD : p.REMOTE_AUDIO_REMOVE;
              t.emitter.emit(l, {
                player: c.playerAttributes,
                userList: t.userList,
                playerList: t.getPlayerList()
      ...
      return r(t, [{
        ...
        value: function (e) {
          ...
          if (r) {
            ...
            for (var s = 0, i = r.length; s < i; s++) r[s].cb.apply(r[s].ctx, t)
          }
        }
      }, {
        key: "off",
  ...
  return function () {
    function t(r, s) {
      var i = this;
      e(this, t), this.ctx = r, this.eventEmitter = new L, this.pusherInstance = null, this.userController = new I(this.eventEmitter, this.ctx), this.EVENT = p, "test" !== s ? wx.getSystemInfo({
        success: function (e) {
    ...
    return r(t, [{
      ...
      key: "enterRoom",
      value: function (e) {
        l.log("[apiLog] [enterRoom]", e);
        var t = function (e) {
          if (!h(e)) return null;
          e.scene = e.scene && "rtc" !== e.scene ? e.scene : "videocall", e.enableBlackStream = e.enableBlackStream || "", e.encsmall = e.encsmall || 0, e.cloudenv = e.cloudenv || "PRO", e.streamID = e.streamID || "", e.userDefineRecordID = e.userDefineRecordID || "", e.privateMapKey = e.privateMapKey || "", e.pureAudioMode = e.pureAudioMode || "", e.recvMode = e.recvMode || 1;
          var t = "";
          return t = e.strRoomID ? "&strroomid=".concat(e.strRoomID) : "&roomid=".concat(e.roomID), "room://cloud.tencent.com/rtc?sdkappid=".concat(e.sdkAppID).concat(t, "&userid=").concat(e.userID, "&usersig=").concat(e.userSig, "&appscene=").concat(e.scene, "&encsmall=").concat(e.encsmall, "&cloudenv=").concat(e.cloudenv, "&enableBlackStream=").concat(e.enableBlackStream, "&streamid=").concat(e.streamID, "&userdefinerecordid=").concat(e.userDefineRecordID, "&privatemapkey=").concat(e.privateMapKey, "&pureaudiomode=").concat(e.pureAudioMode, "&recvmode=").concat(e.recvMode)
        }(e);
        return t || this.eventEmitter.emit(p.ERROR, {
          message: "进房参数错误"
        }), g.setConfig({
          sdkAppId: e.sdkAppID,
          userId: e.userID,
          version: "wechat-mini"
        }), this.pusherInstance.setPusherAttributes(a(a({}, e), {}, {
          url: t
        })), l.warn("[statusLog] [enterRoom]", this.pusherInstance.pusherAttributes), g.log("api-enterRoom"), g.log("pusherConfig: ".concat(JSON.stringify(this.pusherInstance.pusherAttributes))), this.getPusherAttributes()
      }
    }, {
      key: "exitRoom",
      value: function () {
        g.log("api-exitRoom"), this.userController.reset();
        var e = Object.assign({
          pusher: this.pusherInstance.reset()
        }, {
          playerList: this.userController.getPlayerList()
        });
        return this.eventEmitter.emit(p.LOCAL_LEAVE), e
      }
    }, {
      key: "getPlayerList",
      value: function () {
        var e = this.userController.getPlayerList();
        return l.log("[apiLog][getStreamList]", e), e
      }
    }, {
      key: "setPusherAttributes",
      value: function (e) {
      ...
      key: "setPlayerAttributes",
      value: function (e, t) {
        l.log("[apiLog] [setPlayerAttributes] id", e, "options: ", t);
        ...
        return a ? (a.setPlayerAttributes(t), g.log("api-setPlayerAttributes id: ".concat(e, " options: ").concat(JSON.stringify(t))), this.getPlayerList()) : this.getPlayerList()
      }
    }, {
      ...
      value: function (e) {
        var t = this._transformStreamID(e),
          r = t.userID,
          s = t.streamType;
        return l.log("[api][getPlayerInstance] id:", e), this.userController.getStream({
          userID: r,
          streamType: s
        })
      }
      ...
      value: function (e) {
        l.log("[apiLog] [switchStreamType] id: ", e);
        var t = this._transformStreamID(e),
          r = t.userID,
          s = t.streamType,
          i = this.userController.getStream({
            userID: r,
            streamType: s
          });
        return "main" === i._definitionType ? (i.src = i.src.replace("main", "small"), i._definitionType = "small") : (i.src = i.src.replace("small", "main"), i._definitionType = "main"), this.getPlayerList()
      }
    }, {
      ...
      value: function (e) {
        var t = e.detail.info;
        this.pusherInstance.setPusherAttributes(t), this.eventEmitter.emit(p.LOCAL_NET_STATE_UPDATE, {
      ...
      value: function (e) {
        try {
          var t = e.detail.errCode,
            r = e.detail.errMsg;
          this.eventEmitter.emit(p.ERROR, {
            code: t,
            message: r
          })
        } catch (t) {
      ...
      value: function (e) {
        var t, r, s, i;
        this.eventEmitter.emit(p.BGM_PLAY_PROGRESS, {
          progress: null === (t = e.data) || void 0 === t || null === (r = t.detail) || void 0 === r ? void 0 : r.progress,
          duration: null === (s = e.data) || void 0 === s || null === (i = s.detail) || void 0 === i ? void 0 : i.duration
        })
      }
    }, {
      ...
      value: function (e) {
        this.pusherInstance.pusherAttributes.volume = e.detail.volume, this.eventEmitter.emit(p.LOCAL_AUDIO_VOLUME_UPDATE, {
          pusher: this.pusherInstance.pusherAttributes
        })
      }
    }, {
      ...
      value: function (e) {
        ...
        !i || i.videoWidth === e.detail.info.videoWidth && i.videoHeight === e.detail.info.videoHeight || (i.setPlayerAttributes({
          netStatus: e.detail.info
        }), this.eventEmitter.emit(p.REMOTE_NET_STATE_UPDATE, {
          playerList: this.userController.getPlayerList()
        }))
      }
    }, {
      ...
      value: function (e) {
        var t = this._transformStreamID(e.currentTarget.dataset.streamid),
          ...
          a = e.detail.volume;
        i.setPlayerAttributes({
          volume: a
        }), this.eventEmitter.emit(p.REMOTE_AUDIO_VOLUME_UPDATE, {
          playerList: this.userController.getPlayerList()
        })
      }
    }, {
